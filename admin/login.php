...
if(isset($_POST['formconnexion'])) {
   ...
   $pass = ($_POST['pass']);
   if(!empty($usernameconnect) AND !empty($pass)) {
      $requser = $bdd->prepare("SELECT * FROM users WHERE username = ? AND pass = ?");
      $requser->execute(array($usernameconnect, $pass));
        ...
        <div class="form-form">
         ...
         ?>
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="usernameconnect" type="text" class="form-control"
                                        placeholder="Name">
                                </div>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" name="formconnexion" class="btn btn-primary" value="">Log
                                            In</button>
                                    </div>
                                </div>
...
<!-- Mirrored from designreset.com/cork/ltr/demo3/auth_login_boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Apr 2020 02:48:56 GMT -->
