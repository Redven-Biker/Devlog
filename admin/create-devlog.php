        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="create-devlog.php" data-active="true" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-three">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="widget-content widget-content-area">
                                    <form action="add_devlog_post.php" method="post">
                                        <div class="form-group mb-4">
                                            <label for="exampleFormControlInput2">Title</label>
                                            <input type="text" name="title" class="form-control"
                                                id="exampleFormControlInput2" placeholder="Devlog #01">
                                        </div>
                                        <div class="form-group mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="version" class="form-control"
                                                id="exampleFormControlInput2" placeholder="1.0.0">
                                        </div>
